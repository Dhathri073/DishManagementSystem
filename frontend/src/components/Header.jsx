/**
 * Dashboard header: logo, search bar, dark mode toggle.
 */
      ...
      <div className="max-w-7xl mx-auto flex items-center gap-4">
        ...
        <div className="flex-1 max-w-md mx-auto relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 rounded-xl bg-white/60 dark:bg-slate-700/60
        ...
        <button
          ...
          className="p-2 rounded-xl bg-white/60 dark:bg-slate-700/60
            border border-slate-200/60 dark:border-slate-600/60
            hover:bg-white/90 dark:hover:bg-slate-700 transition-all"
        >
          {darkMode ? (
